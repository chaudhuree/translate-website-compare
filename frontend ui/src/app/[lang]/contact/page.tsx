        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label htmlFor="name" className="dark:text-white text-black">{dict.contact.fields.name}</label>
              <Input
                id="name"
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="dark:text-white text-black">{dict.contact.fields.email}</label>
              <Input
                id="email"
          ...
          <div className="space-y-2">
            <label htmlFor="subject" className="dark:text-white text-black">{dict.contact.fields.subject}</label>
            <Input
              id="subject"
          ...
          <div className="space-y-2">
            <label htmlFor="message" className="dark:text-white text-black">{dict.contact.fields.message}</label>
            <Textarea
              id="message"
